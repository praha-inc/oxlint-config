...
export const eslint = () => defineConfig({
  ...
  rules: {
    // Not Built-in eslint plugin
    // 'eslint-js/consistent-this': 'off',
    // 'eslint-js/func-name-matching': 'off',
    // 'eslint-js/id-denylist': 'off',
    // 'eslint-js/id-match': 'off',
    // 'eslint-js/logical-assignment-operators': 'off',
    // 'eslint-js/no-implicit-globals': 'off',
    // 'eslint-js/no-implied-eval': 'off',
    // 'eslint-js/no-restricted-exports': 'off',
    // 'eslint-js/no-restricted-properties': 'off',
    // 'eslint-js/no-restricted-syntax': 'off',
    // 'eslint-js/no-underscore-dangle': 'off',
    // 'eslint-js/no-unreachable-loop': 'off',
    // 'eslint-js/no-useless-assignment': 'off',
    // 'eslint-js/object-shorthand': 'off',
    // 'eslint-js/one-var': 'off',
    // 'eslint-js/prefer-arrow-callback': 'off',
    // 'eslint-js/prefer-named-capture-group': 'off',
    // 'eslint-js/prefer-regex-literals': 'off',
    // 'eslint-js/require-atomic-updates': 'off',
    // 'eslint-js/require-unicode-regexp': 'off',
    // 'eslint-js/strict': 'off',
